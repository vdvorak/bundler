...
RSpec.describe "bundle gem" do
  ...
  shared_examples_for "--rubocop flag" do
    before do
      execute_bundle_gem(gem_name, "--rubocop")
    end
    ...
    it "generates a gem skeleton with rubocop" do
      ...
      expect(bundled_app("test-gem/Gemfile")).to read_as(include('gem "rubocop"'))
    end
  end
